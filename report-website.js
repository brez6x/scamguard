...
exports.default = async (req) => {
  ...
  try {
    ...
    const result = await pool.query('select id, email, password_hash, email_verified from users where email = $1', [email]);
    ...
    if (!user.email_verified) {
      return json(403, {
        error: 'Please verify your email before logging in — check your inbox for the confirmation link we sent you.',
        unverified: true,
      });
    }
